...
class CHPPASCALCompilerCtrl : public COleControl
{
	DECLARE_DYNCREATE(CHPPASCALCompilerCtrl)
...
// Overrides
	...
	//{{AFX_VIRTUAL(CHPPASCALCompilerCtrl)
	public:
...
protected:
	...
	DECLARE_OLECREATE_EX(CHPPASCALCompilerCtrl)    // Class factory and guid
	DECLARE_OLETYPELIB(CHPPASCALCompilerCtrl)      // GetTypeInfo
	DECLARE_PROPPAGEIDS(CHPPASCALCompilerCtrl)     // Property page IDs
	DECLARE_OLECTLTYPE(CHPPASCALCompilerCtrl)		// Type name and misc status
...
// Dispatch maps
	//{{AFX_DISPATCH(CHPPASCALCompilerCtrl)
...
// Event maps
	//{{AFX_EVENT(CHPPASCALCompilerCtrl)
	void FireEvenement()
		{FireEvent(eventidEvenement,EVENT_PARAM(VTS_NONE));}
	void FireFini()
		{FireEvent(eventidFini,EVENT_PARAM(VTS_NONE));}
	//}}AFX_EVENT
	DECLARE_EVENT_MAP()
