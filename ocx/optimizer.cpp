	...
	while (!fini)
	{
		...
		if ((Ins1.op=="CST") && (Ins2.op=="CST") && (Ins3.op=="OP"))
		{
			...
			else
			{
				...
				if ((Ins1.arg1=="BYTE") || (Ins1.arg1=="INTEGER"))
				{
					int n1=StrToInt(Ins1.arg2);
					int n2=StrToInt(Ins2.arg2);
					if (Ins3.arg2=="+") n1+=n2;
					if (Ins3.arg2=="-") n1-=n2;
					if (Ins3.arg2=="*") n1*=n2;
				...
				if ((Ins1.arg1=="FLOAT"))
				{
					double n1=StrToFloat(Ins1.arg2);
					double n2=StrToFloat(Ins2.arg2);
					if (Ins3.arg2=="+") n1+=n2;
					if (Ins3.arg2=="-") n1-=n2;
					if (Ins3.arg2=="*") n1*=n2;
					if (Ins3.arg2=="/") n1/=n2;				
...
int COptimizer::DecalagePile (COptimizer::TInstruction current)
{
	...
	if (current.op=="CALL") return -(StrToInt(current.arg2));
